...
// Updates the Title display at the top of the task list
    function updateCurrentProject(title) {
...
// Creates div containing individual task info
    function displayTodo(task, index) {
    ...
    return { pageStructure, displayProjectsNav, updateCurrentProject, addTaskCard, displayTodo }
})();